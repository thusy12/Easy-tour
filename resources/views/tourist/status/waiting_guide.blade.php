				...
				<div class="container">
					<div class="row">
						<div class="booking-form"> 
							...
							<h3 class="form-header">Tourist Place : {{$booking->district}}</h3>
							<h3 class="form-header">No of Touirist : {{$booking->nop}}</h3>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="booking-form">
							<div class="form-header">
								<h1>Service Finised</h1>
							</div> 
							<a href="/feedbackmsg_guide/{{$guide->id}}" ><button class="submit-btn"><h4>Rate your service and tour</h4></button></a>
