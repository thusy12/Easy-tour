          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                @if(isset($booking))
                      @if( ($booking->book_flag == 0 && $booking->finiesd_flag == 0) || ($booking->book_flag == 1 && $booking->finiesd_flag == 0) ||($booking->book_flag == 2) )
                      <button class="btn btn-success"> 
                        <a href="/status_equipment/{{$equipment->id}}" class="btn btn-success btn-lg">Contact me</a>
                        
                      </button>
                      @else
                      <button class="btn btn-success"> 
                       
                        <a href="/equipmentbooks/{{$equipment->id}}" class="btn btn-success btn-lg">Contact me</a>
                      </button>
                      @endif
                @else
                      <button class="btn btn-success"> 
